...
<html class="no-js" lang="<?php echo get_bloginfo( 'language' ); ?>">
	<head>
		...
		<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
			...
			})(window,document,'script','dataLayer','GTM-K8925PJ');</script>
	...
	<body data-scroll-id="page-top" id="page-top">
		...
		<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K8925PJ" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
